...
curl -XPATCH -H "Content-Type: application/json" \
     -d '{"title": "Some hypervisors are very broken", "impactType": {"slug": "performance_degration"}, "components": [{"slug": "hypervisor-00003"}, {"slug": "hypervisor-00002"}], "phase": {"slug": "closed"}}' \
